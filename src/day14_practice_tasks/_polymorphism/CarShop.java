package day14_practice_tasks._polymorphism;


import day14_practice_tasks.Audi;
import day14_practice_tasks.Car;
import day14_practice_tasks.Honda;
import day14_practice_tasks.Tesla;
...
public class CarShop {
    ...
    public static void main(String[] args) {
        ...
        for (Car car : cars) {
            ...
            boolean forAudi = car instanceof Honda && year >= 2015 && year <= 2019;
            boolean forTesla = car instanceof Honda && year >= 2015 && year <= 2016;
        ...
        System.out.println("Highest price car is " + highestPriceCar);
        System.out.println("Lowest price car is " + lowestPriceCar);
        System.out.println("-----------------------------------------");
