...
public class ClassMatesReversed {
    public static void main(String[] args) {
        ...
        String[] classmates = {"Debra Mayer", "Kenneth Schaden", "Manual Graduate", "Charlotte Tromp", "Lucio Stark",
                "Mary Bauch", "Hilda Prosacco", "Elisha Cole", "Salvatora Hermann", "Kim Cassia"};
